// -*- C++ -*-
//
// Package:    Electron_GNN_Regression/Electron_RecHit_NTuplizer3
// Class:      Electron_RecHit_NTuplizer3
//
/**\class Electron_RecHit_NTuplizer3 Electron_RecHit_NTuplizer3.cc Electron_GNN_Regression/Electron_RecHit_NTuplizer3/plugins/Electron_RecHit_NTuplizer3.cc
...
class Electron_RecHit_NTuplizer3 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit Electron_RecHit_NTuplizer3(const edm::ParameterSet&);
      ~Electron_RecHit_NTuplizer3();
...
//
Electron_RecHit_NTuplizer3::Electron_RecHit_NTuplizer3(const edm::ParameterSet& iConfig):
...
Electron_RecHit_NTuplizer3::~Electron_RecHit_NTuplizer3()
{
...
void
Electron_RecHit_NTuplizer3::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   using namespace std;
...
void
Electron_RecHit_NTuplizer3::beginJob()
{
...
void
Electron_RecHit_NTuplizer3::endJob()
{
}
...
void
Electron_RecHit_NTuplizer3::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void Electron_RecHit_NTuplizer3::TreeSetDiElectronVar(const reco::GsfElectron& electron1, const reco::GsfElectron& electron2){
...
void Electron_RecHit_NTuplizer3::TreeSetSingleElectronVar(const reco::GsfElectron& electron, int index){
...
void Electron_RecHit_NTuplizer3::InitNewTree()
{
...
void Electron_RecHit_NTuplizer3::ResetMainTreeVar()
{
...
void Electron_RecHit_NTuplizer3::TreeSetEventSummaryVar(const edm::Event& iEvent)
{
...
float Electron_RecHit_NTuplizer3::GetMustEnergy(const reco::GsfElectron& electron, bool isEB){
...
void Electron_RecHit_NTuplizer3::TreeSetPileupVar(void)
{
        _rho = *rhoHandle;
        _nPV = 255;
        _nPU = 255;
...
DEFINE_FWK_MODULE(Electron_RecHit_NTuplizer3);

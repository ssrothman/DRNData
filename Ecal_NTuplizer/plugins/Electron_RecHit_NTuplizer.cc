// -*- C++ -*-
//
// Package:    Electron_GNN_Regression/Electron_RecHit_NTuplizer
// Class:      Electron_RecHit_NTuplizer
//
/**\class Electron_RecHit_NTuplizer Electron_RecHit_NTuplizer.cc Electron_GNN_Regression/Electron_RecHit_NTuplizer/plugins/Electron_RecHit_NTuplizer.cc
...
class Electron_RecHit_NTuplizer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit Electron_RecHit_NTuplizer(const edm::ParameterSet&);
      ~Electron_RecHit_NTuplizer();
...
//
Electron_RecHit_NTuplizer::Electron_RecHit_NTuplizer(const edm::ParameterSet& iConfig):
...
Electron_RecHit_NTuplizer::~Electron_RecHit_NTuplizer()
{
...
void
Electron_RecHit_NTuplizer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   using namespace std;
...
void
Electron_RecHit_NTuplizer::beginJob()
{
...
void
Electron_RecHit_NTuplizer::endJob()
{
}
...
void
Electron_RecHit_NTuplizer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void Electron_RecHit_NTuplizer::TreeSetDiElectronVar(const reco::GsfElectron& electron1, const reco::GsfElectron& electron2){
...
void Electron_RecHit_NTuplizer::TreeSetSingleElectronVar(const reco::GsfElectron& electron, int index){
...
void Electron_RecHit_NTuplizer::InitNewTree()
{
...
void Electron_RecHit_NTuplizer::ResetMainTreeVar()
{
...
void Electron_RecHit_NTuplizer::TreeSetEventSummaryVar(const edm::Event& iEvent)
{
...
void Electron_RecHit_NTuplizer::TreeSetPileupVar(void)
{
        _rho = *rhoHandle;
        _nPV = 255;
        _nPU = 255;
...
DEFINE_FWK_MODULE(Electron_RecHit_NTuplizer);
